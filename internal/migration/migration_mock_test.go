...
// Source: github.com/juju/juju/internal/migration (interfaces: AgentBinaryStore,ControllerConfigService,UpgradeService,ApplicationService,CredentialService,RelationService,StatusService,OperationExporter,Coordinator,ModelAgentService,CharmService,ModelService,ModelMigrationService,MachineService)
//
...
func (m *MockModelMigrationService) ModelMigrationMode(arg0 context.Context) (modelmigration0.MigrationMode, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ModelMigrationMode", arg0)
	ret0, _ := ret[0].(modelmigration0.MigrationMode)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockModelMigrationServiceModelMigrationModeCall) Return(arg0 modelmigration0.MigrationMode, arg1 error) *MockModelMigrationServiceModelMigrationModeCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelMigrationServiceModelMigrationModeCall) Do(f func(context.Context) (modelmigration0.MigrationMode, error)) *MockModelMigrationServiceModelMigrationModeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelMigrationServiceModelMigrationModeCall) DoAndReturn(f func(context.Context) (modelmigration0.MigrationMode, error)) *MockModelMigrationServiceModelMigrationModeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
