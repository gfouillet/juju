...
//go:generate go run go.uber.org/mock/mockgen -typed -package mocks -destination mocks/domain_mocks.go github.com/juju/juju/internal/worker/firewaller PortService,ApplicationService,CrossModelRelationService,RelationService
