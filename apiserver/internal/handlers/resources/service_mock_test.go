...
//
//	mockgen -typed -package resources -destination service_mock_test.go github.com/juju/juju/apiserver/internal/handlers/resources ResourceServiceGetter,ResourceService,ApplicationServiceGetter,ApplicationService,ModelServiceGetter,ModelService,ResourceOpenerGetter,Downloader
//
...
func (m *MockApplicationService) GetApplicationDetailsByName(arg0 context.Context, arg1 string) (application.ApplicationDetails, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetApplicationDetailsByName", arg0, arg1)
	ret0, _ := ret[0].(application.ApplicationDetails)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockApplicationServiceGetApplicationDetailsByNameCall) Return(arg0 application.ApplicationDetails, arg1 error) *MockApplicationServiceGetApplicationDetailsByNameCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockApplicationServiceGetApplicationDetailsByNameCall) Do(f func(context.Context, string) (application.ApplicationDetails, error)) *MockApplicationServiceGetApplicationDetailsByNameCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApplicationServiceGetApplicationDetailsByNameCall) DoAndReturn(f func(context.Context, string) (application.ApplicationDetails, error)) *MockApplicationServiceGetApplicationDetailsByNameCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockModelServiceGetterMockRecorder) Model(arg0 any) *MockModelServiceGetterModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Model", reflect.TypeOf((*MockModelServiceGetter)(nil).Model), arg0)
	return &MockModelServiceGetterModelCall{Call: call}
}

// MockModelServiceGetterModelCall wrap *gomock.Call
type MockModelServiceGetterModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockModelServiceGetterModelCall) Return(arg0 ModelService, arg1 error) *MockModelServiceGetterModelCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelServiceGetterModelCall) Do(f func(*http.Request) (ModelService, error)) *MockModelServiceGetterModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelServiceGetterModelCall) DoAndReturn(f func(*http.Request) (ModelService, error)) *MockModelServiceGetterModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockModelService) IsImportingModel(arg0 context.Context) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockModelServiceMockRecorder) IsImportingModel(arg0 any) *MockModelServiceIsImportingModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsImportingModel", reflect.TypeOf((*MockModelService)(nil).IsImportingModel), arg0)
	return &MockModelServiceIsImportingModelCall{Call: call}
}

// MockModelServiceIsImportingModelCall wrap *gomock.Call
type MockModelServiceIsImportingModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockModelServiceIsImportingModelCall) Return(arg0 bool, arg1 error) *MockModelServiceIsImportingModelCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelServiceIsImportingModelCall) Do(f func(context.Context) (bool, error)) *MockModelServiceIsImportingModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelServiceIsImportingModelCall) DoAndReturn(f func(context.Context) (bool, error)) *MockModelServiceIsImportingModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockDownloader) Download(arg0 context.Context, arg1 io.ReadCloser, arg2 string, arg3 int64) (io.ReadCloser, error) {
	m.ctrl.T.Helper()
